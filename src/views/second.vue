<template>
    <div class="home-wrapper" v-loading="pageLoading">
        <el-button type="primary" class="btn-add" @click="addPrimarymenu()">新增一级菜单</el-button>
        <div class="newContent">
            <el-table
                ...
                <el-table-column prop="action"  align="center" label="子分类" width="200">
                    <template slot-scope="scope">
                    <span v-if="!scope.row.link" class="text-link" @click="setting(scope.row.id)">设置</span>
                    </template>
                </el-table-column>
